        ...
        <div class="row">
            ...
            <div class="col-md-4 mb-4">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end mt-3" aria-labelledby="dropdownMenu{{ $item->id }}">
                                ...
                                {{-- <li>
                                    <form action="{{ route('artwork.destroy', $item->id) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus karya ini?');">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="dropdown-item text-danger"><i class="far fa-trash-alt" style="font-size: 1rem"></i> Delete</button>
                                    </form>
                                </li> --}}
                            </ul>
                        </div>
              ...
              <div class="card-body">
                ...
                <p class="card-text">added date : {{$item->submitted_at}}</p>
              </div>
              <div class="container">
